...
public class BoardController {
	...
	public void addBoard(@RequestBody BoardBean model) throws Exception{
	...
	@ResponseBody
	public ArrayList<BoardBean> selectBoardList() throws Exception{
	...
	public void updateBoard(@RequestBody BoardBean model) throws Exception{
		boardDao.updateBoard(model);
	}
	
	//게시글 삭제
	@RequestMapping("/board/removeBoard")
	public void removeBoard(@RequestBody BoardBean model)throws Exception{
